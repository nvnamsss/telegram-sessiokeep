...
if __name__ == "__main__":
    ...
    # adapters
    tel_adapter = telegram.client.Client(
        api_hash="",
        api_id="",
    ...
    # services
    session_service = services.session.SessionService(session_repository=session_repository)
    
    # controllers
    session_controller = controllers.session.SessionController(app=telse, session_service=session_service)
